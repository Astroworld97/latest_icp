...
point_cloud_p_orig, colorDictP = np.array(generate_point_cloud_p(r, h, colorDictP))
point_cloud_p = point_cloud_p_orig.copy()
...
#     p_centroid = point_cloud_centroid(point_cloud_p)
#     # point_cloud_q = create_point_cloud_q_from_matches(point_cloud_p, matchDict)
...
#         point_cloud_p[i] = point_p
# print(best_err)
# plot(point_cloud_p_best, colorDict)
